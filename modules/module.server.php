...
Options: 
	hide_server_name - Whether or not to hide the server's name. Defaults to false.
**/
...
$hide_server_name = key_or_default($Module_Config, "hide_server_name", false);
...
?>
		<div class="<?php if(!$card) { ?>no_card<?php } ?>">
			<div class="server module content">
				...
				<div class="marginless ui header" style="<?php if($hide_server_name) { ?>display: none;<?php } ?>">
					<i class="file text outline icon"></i>
					<div class="content name"></div>
				</div>
				<div class="ui divider" style="<?php if($hide_server_name) { ?>display: none;<?php } ?>"></div>
